function main(){
    ...
    y = 0
    gl.bindBuffer(gl.ARRAY_BUFFER,positionBuffer);
    setCircleVertices(gl, n, 0.5, x, y);
    gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
    setCircleColor(gl,n,[1.0, 0.87, 0.77]);
    ...
    // boca
    gl.bindBuffer(gl.ARRAY_BUFFER, positionBuffer);
    setTriangleVertices(gl, [0.3, -0.2], [0, -0.4], [-0.3, -0.2]);
    gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
    setTriangleColor(gl, [1.0, 0.71, 0.76]); 
    ...
    setCircleVertices(gl, n, 0.12, x, y);
    gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
    setCircleColor(gl,n,[0.0, 1.0, 0.0]);
    gl.drawArrays(gl.TRIANGLES, 0, 3*n);
    ...
    // roupa
    gl.bindBuffer(gl.ARRAY_BUFFER,positionBuffer);
    setRectangleVertices(gl, -0.03, -0.7, 0.06, 0.2);
    gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
    setRectangleColor(gl,[0.0, 0.0, 0.55]);
    gl.drawArrays(gl.TRIANGLES, 0, 6);

    gl.bindBuffer(gl.ARRAY_BUFFER, positionBuffer);
    setTriangleVertices(gl, [0.3, -0.4], [0.2, -0.5], [0.03, -0.5]);
    gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
    setTriangleColor(gl, [0.0, 0.0, 0.55]); 
    gl.drawArrays(gl.TRIANGLES, 0, 3);
